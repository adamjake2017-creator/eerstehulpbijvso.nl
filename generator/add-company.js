...
<section class="block"><div class="wrap"><h2 class="big reveal" id="sociaal-plan">Het sociaal plan bij <em>${c.name}</em></h2>
<div class="prose reveal"><p>Bij een grotere reorganisatie geldt vaak een sociaal plan: de afspraken tussen ${c.name} en de vakbonden of ondernemingsraad over wat er met boventallige medewerkers gebeurt. Denk aan de hoogte van de vergoeding, een van-werk-naar-werk-traject, een opzegtermijn en soms een extra vertrekregeling. Ken je het sociaal plan van ${c.name}, dan weet je waar je recht op hebt voordat je een vaststellingsovereenkomst tekent.</p>
<h3>Sociaal plan en je vaststellingsovereenkomst</h3><p>Je vaststellingsovereenkomst hoort aan te sluiten op het sociaal plan. Soms biedt het plan een vergoeding hoger dan de wettelijke transitievergoeding, bijvoorbeeld via een correctiefactor. In andere gevallen is het plan juist een bodem en valt er individueel meer te onderhandelen. Wij leggen jouw voorstel naast het sociaal plan van ${c.name} en controleren of je krijgt waar je recht op hebt.</p>
<h3>Geen sociaal plan? Dan onderhandel je zelf</h3><p>Niet elke reorganisatie bij ${c.name} kent een sociaal plan. Is er geen plan, dan is je vertrekregeling volledig een kwestie van onderhandelen, en is een scherpe blik op je vergoeding, je WW en je vrijstelling van werk juist extra belangrijk. Ook dan staan wij naast je.</p></div></div></section>
